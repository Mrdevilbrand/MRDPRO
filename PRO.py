...
def lang(cookies):
	...
	if f==True:
		...
		exit("   [!]Cookies expired").format(R,N)
def basecookie():
...
def menu():
  ...
  if r=="":print("\033[0;97m   [!] ").format(R,N);menu()
  elif r=="1":
    publik()
  elif r=="2":
    methode()
    ...
    try:
      ...
      os.remove("login.txt")
      exit(basecookie())
    except Exception as e:print("\033[0;97m   [•] Error file %s"%e)
  else:
...
def publik():
	...
	try:
		...
		ys.close()
		print ("\033[0;96m─────────────────────────────────────────────────────────────")
		print ('\033[0;96m╔══\033[0;97m[•]  successful ides %s'%op['name'])
...
def methode():
  ...
  banner()
  print ("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ choose method ]")
  print("\033[0;96m║")
  ...
  if sek=="":print("\033[0;97m   [!] Isi Yang Benar").format(R,N);methode()
    ...
    print("\033[0;97m   [!] banner").format(R,N);methode()
def logs():
  banner()
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ choose Login  method]")
  print("\033[0;96m║")
  ...
  if sek=="":
    print("\033[0;97m   [!] banner").format(R,N);logs()
  elif sek=="1":
    log_token()
  elif sek=="2":
    gen()
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print("\r   [MRD_OK]%s %s • %s %s      "%(G,fl.get("id"),i,N))
					...
					print("\r   [MRD_CP]%s %s • %s %s      "%(O,fl.get("id"),i,N))
